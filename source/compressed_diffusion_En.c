...
{
    mwSize N,L,K,M;
    double *A, *C, *w_0, *u, *d, *mu, *w_star, *e, *w_k ,*H, *En;
    
    
    /* check for proper number of arguments */
    if(nrhs!=10) {
        mexErrMsgIdAndTxt("DiffusionToolbox:compressed_diffusion:nrhs","Ten inputs required.");
    }
    if(nlhs!=2) {
    ...
    compressed_diffusion_En(N, L, K,M, w_star, w_0, A, C, mu, d, u, H, En, e, w_k);
